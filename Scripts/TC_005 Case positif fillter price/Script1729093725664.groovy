...
WebUI.dragAndDropToObject(findTestObject('Page_Products  Automation Practice Site/div_FilterPrice 470  500'), findTestObject(
        'Page_Products  Automation Practice Site/span_Filter by price_ui-slider-handle ui-corner-all ui-state-default ui-state-hover'), 
...
WebUI.click(findTestObject('Page_Checkout  Automation Practice Site/div_Billing DetailsFirst Name Last Name Com_f3e123'))
